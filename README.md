This application is a demonstration of how to prevent an Android Fragment from rotating when all other fragments in the activity are permitted to rotate (or vice versa).
